...
from lib.util import File, send_message_to_telegram
...
def run_daily():
    ...
    for DataTime in time_list:
        ...
        send_message_to_telegram("GMAO plot finish")
...
if __name__ == "__main__":
    ...
    logging.info("server start schedule")
    send_message_to_telegram("GMAO server restart")

    # schedule.every().day.at("22:10").do(run_daily)
    schedule.every().day.at("01:40").do(run_daily)
    # run_daily()
    while True:
