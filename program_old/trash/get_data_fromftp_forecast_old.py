...
for i,ida in enumerate(day_list):
    ...
    # GEOS.fp.fcst.inst1_2d_hwl_Nx.20200924_00+20200923_2200.V01.nc4
    # GEOS.fp.fcst.inst1_2d_hwl_Nx.\d+_00\+\d+_2200
